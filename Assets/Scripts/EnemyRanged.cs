...
public class EnemyRanged : Enemy
{
    ...
    void Update()
    {
        ...
        else if (playerInRange && !isAttacking)
        {
            ...
            Vector2 targetPosition = player.position - firePoint.position;
            float rotationZ = Mathf.Atan2(targetPosition.y, targetPosition.x) * Mathf.Rad2Deg;
            firePoint.rotation = Quaternion.Euler(0f, 0f, rotationZ);
        }
    ...
    private void Shoot()
    {
        ...
        GameObject temp = Instantiate(bullet, transform.position, firePoint.rotation, null);
    }
